...
if __name__ == "__main__":
    ...
    if figure0:
        ...
        # log_path = "data/log_200223_12H16M08.log"
        log_path = "data/log_200623_15H18M45.log"
        f = open_log(log_path)
    ...
    if figure2:
        ...
        tn = open_pkl("data/FC_21X22_asc_tn.pkl")
        hs = open_pkl("data/FC_21X22_asc_hs.pkl")
    ...
    if figure3:
        ...
        tel = open_pkl("data/FC_21X22_asc_tel.pkl")
    ...
    if figure4:
        ...
        try:
            corr_spear, thresholds = open_pkl("data/corr_tel_tmin.pkl")
        except:
            thresholds = np.logspace(np.log10(0.1), np.log10(50), 50)
            save = True
            tel = open_pkl("data/FC_21X22_asc_tel.pkl")
            ts = open_pkl("data/FC_21X22_asc_tn.pkl")
    ...
    if figure5:
        print("######################## Figure 5 ########################")
        # X_train, Y_train = open_pkl("data/bal_train.pkl")
        # X_test, Y_test = open_pkl("data/bal_test.pkl")
    ...
    if figure7:
        ...
        log_path = "data/log_210623_14H08M50.log"
        f = open_log(log_path)
